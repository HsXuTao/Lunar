package com.taoxu.library.utils.calendar;
...
public final class Lunar {
    ...
    private static String[] daysOfAlmanac = {"初一", "初二", "初三", "初四", "初五", "初六",
            "初七", "初八", "初九", "初十", "十一", "十二", "十三", "十四", "十五", "十六", "十七",
            "十八", "十九", "二十", "廿一", "廿二", "廿三", "廿四", "廿五", "廿六", "廿七", "廿八",
            "廿九", "三十"}; // 农历的天数

    //阳历节日
    private final static Map<String, String> theGregorianCalendarDay = new HashMap() {
        {
            put("0101", "元旦");
            put("0501", "劳动节");
            put("1001", "国庆节");
    ...
    //阴历节日
    private final static Map<String, String> theLunarFestival = new HashMap() {
        {
            put("0101", "春节");
            put("0115", "元宵节");
            put("0815", "中秋节");
    ...
    private static Lunar mInstance;
     ...
     * @return String
     */
    private String getChineseDay(int y, int m, int d, Lunar c) {
//        Lunar c = getInstance();
//
...
//        c.computeSolarTerms();
        ...
        if (cd == 1) {
            return getChineseMonth(y, m, d, c);
        }
        return daysOfAlmanac[cd - 1];
    }

    /**
     * 获得阴历表显示的文字,自动识别阳历节日,阴历节日,阴历（优先阴历节日，其次阳历节日，最后阴历日期）
     * @param year
     * @param month
     * @param day
     * @return
     */
    public String getShowStr(int year, int month, int day) {
        Lunar c = getInstance();
        c.setGregorian(year, month, day);
        c.computeChineseFields();
        c.computeSolarTerms();
        int lunarMonth = chineseMonth;
        int lunarDay = chineseDate;
        if (format == null) {
            format = new DecimalFormat("00");
        }
        String key = new StringBuffer().append(format.format(month)).append(format.format(day)).toString();
        if (theGregorianCalendarDay.containsKey(key)) {
            return theGregorianCalendarDay.get(key);
        }
        String lunarkey = new StringBuffer().append(format.format(lunarMonth)).append(format.format(lunarDay)).toString();
        if (theLunarFestival.containsKey(lunarkey)) {
            return theLunarFestival.get(lunarkey);
        }
        return getChineseDay(year, month, day, c);
     ...
     * @return
     */
    private String getChineseMonth(int y, int m, int d, Lunar c) {
//        setGregorian(y, m, d);
...
//        computeSolarTerms();
    ...
    public static void setDaysInGregorianMonth(char[] daysInGregorianMonth) {
        Lunar.daysInGregorianMonth = daysInGregorianMonth;
    }
    ...
    public static void setChineseMonths(char[] chineseMonths) {
        Lunar.chineseMonths = chineseMonths;
    }
    ...
    public static void setBaseChineseYear(int baseChineseYear) {
        Lunar.baseChineseYear = baseChineseYear;
    }
    ...
    public static void setBaseChineseMonth(int baseChineseMonth) {
        Lunar.baseChineseMonth = baseChineseMonth;
    }
    ...
    public static void setBaseChineseDate(int baseChineseDate) {
        Lunar.baseChineseDate = baseChineseDate;
    }
    ...
    public static void setBigLeapMonthYears(int[] bigLeapMonthYears) {
        Lunar.bigLeapMonthYears = bigLeapMonthYears;
    }
    ...
    public static void setSectionalTermMap(char[][] sectionalTermMap) {
        Lunar.sectionalTermMap = sectionalTermMap;
    }
    ...
    public static void setSectionalTermYear(char[][] sectionalTermYear) {
        Lunar.sectionalTermYear = sectionalTermYear;
    }
    ...
    public static void setPrincipleTermMap(char[][] principleTermMap) {
        Lunar.principleTermMap = principleTermMap;
    }
    ...
    public static void setPrincipleTermYear(char[][] principleTermYear) {
        Lunar.principleTermYear = principleTermYear;
    }
    ...
    public static void setChineseMonthNames(String[] chineseMonthNames) {
        Lunar.chineseMonthNames = chineseMonthNames;
    }
    ...
    public static void setPrincipleTermNames(String[] principleTermNames) {
        Lunar.principleTermNames = principleTermNames;
    }
    ...
    public static void setSectionalTermNames(String[] sectionalTermNames) {
        Lunar.sectionalTermNames = sectionalTermNames;
    }
